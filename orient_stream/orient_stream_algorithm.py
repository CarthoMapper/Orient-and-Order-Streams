...
from .Diplom_temp import orient_streams #Orient_Streams_Script
...
class OrientStreamAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        """
        rivers = self.parameterAsSourse(parameters, self.INPUT, context)
        ...
        orient_streams(rivers, dem, field, output)
